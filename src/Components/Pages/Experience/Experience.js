              ...
              <Accordion.Collapse eventKey="0">
                <Card.Body>
                  <div className="era-container">
                    <ul>
                      <li>
                        I finally started learning programming, taking a course
                        in Front-End Web Development at "Scoala Informala de
                        IT".
                      </li>
                      <li>
                ...
                <Card.Body>
                  ...
                  <div className="era-container">
                    ...
                    <div className="experience-details">
                      <ul>
                        <li>
                          Before I started learning about Web Development, after
                          8+ years working in sales, I wanted to take some time
                          and think about my future.
                        </li>
                        <li>
                          So in this period of time I continued researching some
                          areas that for some time interested me.
                        </li>
                        <li>
                          Among other things, the list included programming,
                          Forex trading and starting an online business on
                          Amazon, for the former actually taking an online class
                ...
                <Card.Body>
                  <div className="galt-era-container">
                    <div className="experience-details galt-experience-details">
                      <ul>
                        <li>
                          I started in a totally new field for me, learning and
                          getting passionate about watches.
                        </li>
                        <li>
                          Some of my responsabilities included finding new
                          clients, providing professional counseling to the
                          shop's clients, organizing private presentations with
                          special pieces for top clients and data analysis of
                          the stock and monthly sales variations.
                        </li>
                        <li>
                          One of my biggest improvements to the company was
                          creating a comprehensive form of data analysis, which
                          helped the company to observe the sales trends and
                          adjust the orders accordingly.
                        </li>
                        <li>
                          I am grateful that during this period I got to take a
                          special in-depth look into this fascinating world of
                          luxury watches, visiting factories and participating
                          in the yearly Baselworld watch-fair in Switzerland.
                        </li>
                      </ul>
                    </div>
                ...
                <Card.Body>
                  <div className="era-container">
                    ...
                    <div className="experience-details">
                      <ul>
                        <li>
                          infoLocal was a very interesting start-up, providing a
                          premium free advertising magazine to the citizens of
                          Cluj-Napoca and also a delivery service.
                        </li>
                        <li>
            ...
            <Card>
              <Card.Header>
                <Accordion.Toggle as={Card.Header} variant="link" eventKey="4">
                  <p className="experience-title">
                    May 2010 - Aug 2010: Loans Consultant at Patria Credit (now
                    Patria Bank)
                  </p>
                </Accordion.Toggle>
              </Card.Header>
                  ...
                  <div className="era-container">
                    <div className="experience-details">
                      <ul>
                        ...
                        <li>
                          At Patria Credit, my responsabilities included finding
                          new clients, mainly using cold-calling, setting up
                          meetings with interested clients, providing
                    ...
                    <div className="experience-details">
                      <ul>
                        <li>
                          ...
                          Raiffeisen Banca Pentru Locuinte, but it also offered
                          it own banking products.
                        </li>
                        <li>
                          Some of my responsabilities included finding new
